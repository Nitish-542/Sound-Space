...
<div class="row">
    <form action="<?php echo e(route('instruments.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Musically\musically\resources\views/instruments/create.blade.php ENDPATH**/ ?>