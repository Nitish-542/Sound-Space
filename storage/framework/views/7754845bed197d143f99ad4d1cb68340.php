        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('instruments.index')); ?>" class="btn btn-primary">Manage Instruments</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('accessories.index')); ?>" class="btn btn-primary">Manage Accessories</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Musically\musically\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>